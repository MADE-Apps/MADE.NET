...
namespace MADE.Networking.Requests.Json
{
    ...
    public class PostNetworkRequest : JsonResponseNetworkRequest
    {
        ...
        /// The type of response expected from the request.
        /// </param>
        public PostNetworkRequest(string url, object content, Type responseType)
        ...
        /// The type of response expected from the request.
        /// </param>
        public PostNetworkRequest(string url, Dictionary<string, string> headers, object content, Type responseType)
