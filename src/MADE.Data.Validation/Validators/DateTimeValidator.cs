...
namespace MADE.Data.Validation.Validators
{
    ...
    /// <summary>
    /// Defines a data validator for ensuring a value is a valid <see cref="DateTime"/> value.
    /// </summary>
    public class DateTimeValidator : IValidator
    {
        ...
        /// </summary>
        public string Key { get; set; } = nameof(DateTimeValidator);
        ...
        {
            get => this.feedbackMessage.IsNullOrWhiteSpace() ? Resources.DateTimeValidator_FeedbackMessage : this.feedbackMessage;
        ...
        public void Validate(object value)
        {
            ...
            this.IsInvalid = !DateTime.TryParse(str, out DateTime _);
            this.IsDirty = true;
        }
    }
}
